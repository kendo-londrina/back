...
public class CreateGraduacaoFixtureCollection : ICollectionFixture<CreateGraduacaoFixture>
{ }

public class CreateGraduacaoFixture : GraduacaoUsecaseBaseFixture
{
    public CreateGraduacaoInput GetInput() => new(
        GetNomeValido(),
        GetDescricaoValida(),
        GetRandomBoolean()
    );
